...
def make_system_e(h, dt, substeps, electrons_per_packet):
    system = System()
    ...
    # "infinite" hot electron lifetime
    ...
    slice_properties_2b.ds_up = 1000.0  # (eV^-1 nm^-3)
    slice_properties_2b.ds_dn = 1000.0  # (eV^-1 nm^-3)
    slice_properties_2b.tau = 10.0  # (fs)
    ...
    # case 1
    plane_properties_1.alpha_up = 48.0  # (eV^-1 nm^-1 fs^-1)
    plane_properties_1.alpha_dn = 12.0  # (eV^-1 nm^-1 fs^-1)

    # case 2
    #plane_properties_1.alpha_up = 52.0  # (eV^-1 nm^-1 fs^-1)
    #plane_properties_1.alpha_dn = 8.0  # (eV^-1 nm^-1 fs^-1)

    # case 3
    #plane_properties_1.alpha_up = 44.0  # (eV^-1 nm^-1 fs^-1)
    #plane_properties_1.alpha_dn = 16.0  # (eV^-1 nm^-1 fs^-1)

    plane_properties_2 = PlaneProperties()
    plane_properties_2.alpha_up = 180  # (eV^-1 nm^-1 fs^-1)
    plane_properties_2.alpha_dn = 180  # (eV^-1 nm^-1 fs^-1)
